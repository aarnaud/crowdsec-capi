...
// ScopeValue validates that scope is a known value and that value is valid for that scope.
// It is a subset of DecisionFields that does not check the decision type.
func ScopeValue(scope, value string) error {
